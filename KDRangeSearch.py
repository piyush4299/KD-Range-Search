...
class TwoDimensionRangeSearch:
    ...
    def findPoint(self, point, vertical, points, left, down, right, up):
        ...
        if not vertical:
            ...
            mid += -1 if mid % 2 == 0 and mid != 0 else 0  # If mid is even then subtract 1 from it to make it odd
            ...
            mid = len(points)//2
            print(len(points),mid)
            mid += -1 if mid % 2 == 0 and mid != 0 else 0 # If mid is even then subtract and make it odd
